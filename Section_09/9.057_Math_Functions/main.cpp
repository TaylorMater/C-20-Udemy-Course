...
int main(){
    ...
    //gives you 7, largest possible integer less than or equal to value


    // ceil
    std::cout << "Weight rounded to ceil is : " << std::ceil(weight) << std::endl;
    //gives you 8, the smallest possible integer greater than or equal to value
    ...
    //be careful with floating points. Remember numerical analysis
